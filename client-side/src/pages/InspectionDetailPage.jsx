      ...
      >
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <div className='flex items-center space-x-1 text-gray-500'>
                    ...
                    <button
                      ...
                      className="p-1 rounded transition-colors duration-200 hover:bg-gray-400"
                    >
                      <svg
        ...
        {isImageModalOpen && modalImageData && (
          ...
          <div className="fixed inset-0 backdrop-blur-sm bg-black/80 flex items-center justify-center z-50 p-4">
            <div className='bg-white rounded-lg w-auto max-w-[90vw] max-h-[90vh] flex flex-col shadow-xl'>
              {/* Modal Header */}
              <div className='flex justify-between items-center p-4 border-b border-gray-200'>
                ...
                <button
                  ...
                  className='text-gray-400 hover:text-red-600 text-2xl font-light'
                >
                  ✕
                </button>
              </div>
              ...
              {/* Modal Content */}
              <div className='flex-1 overflow-hidden flex justify-center items-center p-2'>
                {/* Image Display */}
